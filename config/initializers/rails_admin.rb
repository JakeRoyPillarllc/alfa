# RailsAdmin config file. Generated on November 29, 2011 11:02
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Alfa', 'Admin']
  ...
  # config.excluded_models = [Gallery, Member, PressItem, Project, ProjectType]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Gallery, Member, PressItem, Project, ProjectType]
  ...
  #   # Found associations:
  #     field :project, :belongs_to_association   #   # Found columns:
  #     field :id, :integer 
  #     field :project_id, :integer         # Hidden 
  ...
  #     field :photo, :paperclip   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
